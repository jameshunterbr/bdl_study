...
vldf |> 
  gghistogram(x = "bl",
              ...
              add = "mean",
              add.params = list(color = palettes$jim_palette_1[2], size = 1.2),
              xlab = "Viral Load",
              ylab = "Count",
              ggtheme = theme_bw()) +
...
censordf |> 
  ggdensity(x = "w48",
            ...
            xlim = c(0, 110),
            ggtheme = theme_bw()) +
  geom_vline(xintercept = mean(censordf$w48), size = 1.2, color = "black") +
  annotate("text", x = 75, y = .06, label = "Mean Censored", color = "black") +
  geom_vline(xintercept = mean(vldf$w48), size = 1.2, color = "black") +
  annotate("text", x = 40, y = .04, label = "Mean True", color = "black")
```
...
go_zero |> 
  ggdensity(x = "zero_w48",
            ...
            xlim = c(0, 110),
            ggtheme = theme_bw()) +
  geom_vline(xintercept = mean(go_zero$zero_w48), size = 1.2, color = "black") +
  annotate("text", x = 20, y = .06, label = "Mean Zeroed", color = "black") +
  geom_vline(xintercept = mean(vldf$w48), size = 1.2, color = "black") +
  annotate("text", x = 40, y = .04, label = "Mean True", color = "black")
```
